/*
	DeathType.class				Petri Dish Sim 1.0 release
	By: Jonathan Zepp - @DaJMasta
	
	An enum to keep track of death types of AdvancedOrganisms.
...
public enum DeathType {
	ALIVE, KILLED, OLD_AGE, STARVATION, COLD, HEAT, TOXICITY, NUTRITION
}
