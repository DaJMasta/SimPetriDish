/*
	EntityType.class				Petri Dish Sim 1.0 release
	By: Jonathan Zepp - @DaJMasta
	
	An enum for keeping track of basic entity types.
...
public enum EntityType {
	NOTHING, BOUNDARY, LIGHT_SOURCE, OBJECT, ORGANIC_OBJECT, ORGANISM, PLUME
}
